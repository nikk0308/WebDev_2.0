...
var Post = function () {
    ...
    var Post = _classThis = /** @class */ (function () {
        function Post_1() {
            ...
            this.comments = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _comments_initializers, void 0));
            this.likes = (__runInitializers(this, _comments_extraInitializers), __runInitializers(this, _likes_initializers, void 0));
            __runInitializers(this, _likes_extraInitializers);
        }
        return Post_1;
    }());
    ...
    (function () {
        ...
        _comments_decorators = [(0, typeorm_1.OneToMany)(function () { return comment_entity_1.Comment; }, function (comment) { return comment.post; })];
        _likes_decorators = [(0, typeorm_1.OneToMany)(function () { return like_entity_1.Like; }, function (like) { return like.post; })];
