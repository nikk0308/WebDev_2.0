...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.register = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersRepository.findOneBy({ email: createUserDto.email })];
                        case 1:
                            existingUser = _a.sent();
                            if (existingUser) {
                                throw new common_1.NotFoundException('Користувач з таким email вже існує');
                            }
