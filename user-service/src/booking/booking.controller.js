...
var BookingController = function () {
    ...
    var BookingController = _classThis = /** @class */ (function () {
        ...
        BookingController_1.prototype.create = function (createBookingDto) {
            return this.bookingService.create(createBookingDto);
        };
        BookingController_1.prototype.findByUser = function (user_id) {
            return this.bookingService.findByUser(user_id);
        };
        BookingController_1.prototype.cancel = function (bookingId) {
    ...
    (function () {
        ...
        _findByUser_decorators = [(0, common_1.Get)(':user_id')];
        _cancel_decorators = [(0, common_1.Delete)(':bookingId')];
