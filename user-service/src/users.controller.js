...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.register = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.register(createUserDto)];
                });
            });
        };
    ...
    (function () {
        ...
        _getUserById_decorators = [(0, common_1.Get)(':id')];
